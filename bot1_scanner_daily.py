...
def detecteaza_pullback(df, simbol):
    try:
        ...
        if risc_per_actiune <= 0: return None
        ...
        return {
            ...
            'swing_low': round(swing_low, 2), 'data_setup': datetime.now().strftime('%Y-%m-%d'),
...
def main():
    ...
    for simbol in watchlist:
        ...
        try:
            ...
            if res:
                ...
                print(f"[SEMNAL] {simbol} identificat.")
        except: continue
    ...
    if semnale_noi:
        ...
        print("[INFO] Niciun setup nou astazi conform filtrelor stricte.")
